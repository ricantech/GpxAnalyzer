package rican.task.data.gpxAnalyzer.api.controller;
...
import rican.task.data.gpxAnalyzer.api.response.RepresentationConverter;
import rican.task.data.gpxAnalyzer.api.controller.validator.GpxFile;
import rican.task.data.gpxAnalyzer.domain.service.PathService;
